...
samtools idxstats /project/chri1594/1_linux/rnaseq/mapped_reads/sorted.bam > /project/chri1594/1_linux/rnaseq/mapped_reads/sorted.idxstats
samtools flagstat /project/chri1594/1_linux/rnaseq/mapped_reads/sorted.bam > /project/chri1594/1_linux/rnaseq/mapped_reads/sorted.flagstat
