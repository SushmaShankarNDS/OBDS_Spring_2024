...
samtools view -b -@12 --with-header /project/chri1594/1_linux/rnaseq/mapped_reads/ERR1755082.sam > /project/chri1594/1_linux/rnaseq/mapped_reads/ERR1755082.bam
samtools sort -@12 /project/chri1594/1_linux/rnaseq/mapped_reads/ERR1755082.bam > sorted.bam
