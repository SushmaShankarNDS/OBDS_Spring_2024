...
-t exon \
-g gene_id \
-a /project/chri1594/1_linux/rnaseq/genome/Mus_musculus.GRCm38.102.gtf.gz \
-o /project/chri1594/1_linux/rnaseq/quantification/counts.txt \
-s 2 \
/project/chri1594/1_linux/rnaseq/mapped_reads/sorted.bam
